...
//in first octant,inc y by 1, x can be x or (x-1) depending on P[as we check with (x-0.5,y+1)] {as we move along the boundary, rate of change of x will be less,so we need more pixels wrt x}
